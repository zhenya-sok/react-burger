...
const OrderDetails = ({bookingNumber}) => {
    return(
        <div className={styles.wrapper}>
            <p className={`${styles.bookingNumber} text text_type_digits-large mt-4 mb-8`}>{bookingNumber}</p>
            <p className="text text_type_main-medium">идентификатор заказа</p>
            <img className={styles.image} src={orderIsAccepted} alt="заказ принят иконка" />
